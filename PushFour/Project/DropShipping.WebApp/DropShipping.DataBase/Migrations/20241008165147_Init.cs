    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "Name", "SortOrder", "UserId" },
                values: new object[,]
                {
                    { 1, "Toys", 1, 1 },
                    { 2, "Kitchen", 2, 2 }
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "CategoryId", "Description", "Name", "OrderId", "Price", "Quantity", "UserId" },
                values: new object[] { 3, 1, "mnogu brza", "kolichka", null, 20.989999999999998, 15, 1 });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "CategoryId", "Description", "Name", "OrderId", "Price", "Quantity", "UserId" },
                values: new object[] { 4, 2, "mnogu brz", "motorche", null, 21.989999999999998, 13, 2 });
