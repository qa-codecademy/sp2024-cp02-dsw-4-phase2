            ...
            foreach (var productDto in updateCategoryDto.ProductDtos)
            {
                if (productDto.Id != 0)
                {
                    ...
                    if (existingProduct != null)
                    {
                        ...
                        existingProduct.OnSale = productDto.OnSale;
                        existingProduct.SalePrice = productDto.SalePrice;
                        // If you need to update any other properties (e.g., Image, OnSale, SalePrice), add them here
                    }
                }
                else
                {
                    ...
                    var newProduct = new Product
                    {
                        ...
                        CategoryId = categoryDb.Id, // Make sure to set the correct category ID
                    };
