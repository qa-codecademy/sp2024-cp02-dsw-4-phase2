...
namespace DropShipping.Services.Implementations
{
    public class ProductService : IProductService
    {
        ...
        public void UpdateProduct(UpdateProductDto updateProductDto)
        {
            ...
            if (productDb == null)
            {
                throw new ProductNotFoundException($"Product with ID: {updateProductDto.Id} was not found!");
            }

            User userDb = _userRepository.GetById(updateProductDto.UserId);
            if (userDb == null)
            {
                throw new ProductNotFoundException($"User with ID: {updateProductDto.UserId} was not found");
            }

            if (string.IsNullOrEmpty(updateProductDto.Name))
            {
                throw new ProductDataException("Name: Name is required field!");
            }

            if (string.IsNullOrEmpty(updateProductDto.Description))
            {
                throw new ProductDataException("Description: Description is required field!");
            }

            if (updateProductDto.Quantity == null)
            {
                throw new ProductDataException("Quantity: Quantity is required field!");
            }

            if (updateProductDto.Price == null)
            {
                throw new ProductDataException("Price: Price is required field!");
            }
        ...
        public void AddProduct(AddProductDto addProductDto)
        {
            ...
            if (userDb == null)
            {
                throw new ProductDataException($"User with ID: {addProductDto.UserId} does not exist!");
            }
            ...
            {
                throw new ProductDataException("Category Name: Category name is required field");
            }
        }
